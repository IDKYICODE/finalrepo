...
const ServiceCard = ({ Icon, title, description, iconColor, bgColor }) => (
  <div className="bg-white rounded-lg p-4 sm:p-6 lg:p-8 text-center shadow-lg hover:shadow-xl transition-shadow min-h-[250px] sm:min-h-[300px] lg:min-h-[400px] flex flex-col items-center">
    <div className={`w-16 h-16 sm:w-24 sm:h-20 lg:w-32 lg:h-20 ${bgColor} rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 lg:mb-6`}>
      <Icon className={`w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 ${iconColor}`} />
    </div>
    <h3 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-4 lg:mb-6">{title}</h3>
    <p className="text-gray-600 flex-grow leading-relaxed text-xs sm:text-sm lg:text-base">{description}</p>
  </div>
);
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 py-6 sm:py-8 lg:py-12">
      ...
      <div className="text-center mb-8 sm:mb-12 lg:mb-20">
        <p className="text-blue-600 text-xs sm:text-sm lg:text-base mb-2">Everything You Need Is Here</p>
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 lg:mb-6">Your Accounting Done Right.</h1>
        <p className="text-gray-600 max-w-3xl mx-auto leading-relaxed text-xs sm:text-sm lg:text-base px-2 sm:px-4">
